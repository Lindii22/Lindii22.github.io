...
<head>
  <meta charset="utf-8">
  <title>Air Albania Roleplay #1 GTA</title>
...
<body class="body">
  <div class="content">
    <div class="container-2 w-container">
      <div>
        <a data-w-id="fd97c34e-0ce6-5332-f83e-8075cd6b6278" style="opacity:0" href="https://cfx.re/join/eyjm4b" class="button w-button">CONNECT</a>
      </div>
    </div>
    <div class="header-logo w-container">
      <div><img src="images/BUBBLE.png" loading="lazy" srcset="images/BUBBLE-p-500.png 500w, images/BUBBLE.png 500w" sizes="120px" alt="" class="image"></div>
    </div>
    <div class="container-3 w-container">
      <div class="w-layout-grid grid">
        <div id="w-node-b697e036-735e-08c0-bc5b-b13cca0d2141-9d8417b5">
          <h1 data-w-id="5f1a2e51-a3ab-5529-5457-621fa6de47d5" style="opacity:0" class="heading-2">Air Albania Roleplay</h1>
          <div data-w-id="7d10a558-c8cd-9ea6-718c-d1ba93f2dfa5" style="opacity:0" class="text-block-2">Air Albania (Role Play) - The best Role Play Server on<br>FiveM, join now to get exited!</div>
          <a data-w-id="8cbfab13-cb16-26d0-f544-6175ac9f5780" style="opacity:0" href="https://cfx.re/join/eyjm4b" class="button-2 w-button">JOIN NOW</a>
          <div class="html-embed w-embed">Online: <?php
$file = file_get_contents('http://localhost:30120/dynamic.json');
...
echo $clients;?>/64</div>
    ...
    <div class="container-4 w-container">
      <div class="w-layout-grid grid-2">
        ...
        <div id="w-node-abbf86c0-3ac5-ca79-cea8-2f6425308db3-9d8417b5" data-w-id="abbf86c0-3ac5-ca79-cea8-2f6425308db3" style="opacity:0" class="div-block">
          <a href="https://discord.gg/airalbaniarp" class="button-6 w-button"><br>‍</a><img src="images/Design-ohne-Titel---2022-11-06T235554.447.png" loading="lazy" width="75" srcset="images/Design-ohne-Titel---2022-11-06T235554.447-p-500.png 500w, images/Design-ohne-Titel---2022-11-06T235554.447.png 500w" sizes="75px" alt="">
        </div>
        ...
        <div id="w-node-dd1ffc17-3e8c-8b61-4318-0a57108c5969-9d8417b5" data-w-id="dd1ffc17-3e8c-8b61-4318-0a57108c5969" style="opacity:0" class="div-block">
          <a href="https://cfx.re/join/eyjm4b" class="button5 w-button"><br>‍</a><img src="images/Design-ohne-Titel---2022-11-06T235718.458.png" loading="lazy" width="75" srcset="images/Design-ohne-Titel---2022-11-06T235718.458-p-500.png 500w, images/Design-ohne-Titel---2022-11-06T235718.458.png 500w" sizes="75px" alt="">
        </div>
        <div id="w-node-b8cc9362-05d2-b704-fe25-ac8f58f13102-9d8417b5" data-w-id="b8cc9362-05d2-b704-fe25-ac8f58f13102" style="opacity:0" class="div-block">
          <a href="https://cfx.re/join/eyjm4b" class="button7 w-button"><br>‍</a><img src="images/Design-ohne-Titel---2022-11-06T235753.465.png" loading="lazy" width="75" srcset="images/Design-ohne-Titel---2022-11-06T235753.465-p-500.png 500w, images/Design-ohne-Titel---2022-11-06T235753.465.png 500w" sizes="75px" alt="">
        </div>
      </div>
    </div>
  </div>
  <div data-w-id="20457081-b171-75af-2b5a-17a411b77587" style="opacity:0" class="background">
    ...
    <h1 class="heading-4">Air Albania</h1>
